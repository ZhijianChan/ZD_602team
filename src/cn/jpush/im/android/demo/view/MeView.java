...
public class MeView extends LinearLayout {
    ...
    public void initModule() {
        ...
        mQrRl = (RelativeLayout) findViewById(R.id.qrcode_info_rl);
        mTagRl = (RelativeLayout) findViewById(R.id.tag_info_rl);
        mContactRl = (RelativeLayout) findViewById(R.id.contact_info_rl);
    ...
    public void setListeners(OnClickListener onClickListener) {
        ...
        mQrRl.setOnClickListener(onClickListener);
        mTagRl.setOnClickListener(onClickListener);
        mContactRl.setOnClickListener(onClickListener);
    }
    ...
    public void setOnTouchListener(OnTouchListener listener){
        ...
        mQrRl.setOnTouchListener(listener);
        mTagRl.setOnTouchListener(listener);
        mContactRl.setOnTouchListener(listener);
    }
